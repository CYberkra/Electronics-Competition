...
#
# Verify project and configure DDS Compiler IP (corrected parameters)
# Run: vivado -mode batch -source scripts/verify_and_configure_ip_v2.tcl
...
# Remove existing IP if any (to start fresh)
...
# Core parameters for AWG requirements
